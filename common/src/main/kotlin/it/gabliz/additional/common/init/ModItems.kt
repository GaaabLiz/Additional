...
class ModItems() {
    ...
    companion object : CommonRegisterHelper.Items , TranslationProvider{

        val itemsList = mutableMapOf<Item, ModObjectInfo.Item>()
        ...
        val DEBUG_ITEM = DebugItem("debug_item", "DEBUG ITEM (ONLY DEV)")
